...
/**
 * Konstruktor
 * @param cpu takt procesoru
 * @param clock požadovaná frekvence rozhranní
 */
 ...
 * @param data bajt dat posílaný po TWI
 */
...
/**
 * Srovná stav s očekávaným
 * @param expected bajt reprezentující očekávaný stav
 * @return Odpovídá stav?
 */
